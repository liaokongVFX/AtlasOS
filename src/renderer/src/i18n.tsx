...
const zhCN = {
  ...
  'settings.aiDeleteProfileConfirm': '删除这个 AI 配置？',
  'settings.aiDescription': '配置 OpenAI / Anthropic 兼容端点，并选择翻译使用的模型。',
  'settings.aiEmpty': '暂无 AI 设置。',
  'settings.aiFormat': '格式',
  'settings.aiFormatAnthropic': 'Anthropic',
  'settings.aiFormatOpenAi': 'OpenAI',
  'settings.aiModel': 'Model',
  'settings.aiNoProfiles': '还没有 AI 配置。',
  'settings.aiNoTranslationProfile': '未选择',
  'settings.aiProfile': '模型端点',
  'settings.aiProfileDescription': '每个配置包含一个兼容 API 端点、模型和安全保存的密钥。',
  'settings.aiProfileName': '名称',
  'settings.aiProfiles': 'AI 配置',
  ...
  'settings.aiTranslationDescription': '选择翻译默认使用的配置、目标语言和双 Ctrl 触发方式。',
  'settings.aiTranslationProfile': '翻译配置',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'settings.ai': 'AI',
  'settings.aiAddProfile': 'Add profile',
  'settings.aiApiKey': 'API Key',
  ...
  'settings.aiDeleteProfileConfirm': 'Delete this AI profile?',
  'settings.aiDescription': 'Configure OpenAI / Anthropic-compatible endpoints and choose the model used for translation.',
  'settings.aiEmpty': 'No AI settings yet.',
  'settings.aiFormat': 'Format',
  'settings.aiFormatAnthropic': 'Anthropic',
  'settings.aiFormatOpenAi': 'OpenAI',
  'settings.aiModel': 'Model',
  'settings.aiNoProfiles': 'No AI profiles yet.',
  'settings.aiNoTranslationProfile': 'Not selected',
  'settings.aiProfile': 'Model endpoint',
  'settings.aiProfileDescription': 'Each profile stores a compatible API endpoint, model, and secure API key.',
  'settings.aiProfileName': 'Name',
  'settings.aiProfiles': 'AI profiles',
  ...
  'settings.aiTranslationDescription': 'Choose the default profile, target language, and double-Ctrl triggers for translation.',
  'settings.aiTranslationProfile': 'Translation profile',
